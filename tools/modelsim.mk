...
export PATH := $(PATH):/afs/tu-berlin.de/units/Fak_IV/aes/tools/mentor/questasim/linux_x86_64
export LD_LIBRARY_PATH := $(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu:/afs/tu-berlin.de/units/Fak_IV/aes/tools/mentor/lib64
...
IterationLimit = 5000
BreakOnAssertion = 3
MessageFormatBreakLine = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatBreak     = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormat          = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatNote      = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatWarning   = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatError     = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatFail      = %F:%L:%i;%T:%D;%S;%R\\n
MessageFormatFatal     = %F:%L:%i;%T:%D;%S;%R\\n
ShowFunctions = 1
